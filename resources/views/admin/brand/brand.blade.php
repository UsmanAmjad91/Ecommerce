...
<div class="page-container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-data__tool">
                            <p><a href="{{url('/admin/dashboard')}}">Dashboard</a> <span> > </span> <a href="{{url('/admin/add_brand')}}"><span>brand List</span></a> </p>
                        ...
                        <p class="ml-3 text-sm font-bold text-green-600" id="catmsg">{{ session()->get('msgbrand') }}</p>
                        @endif
    ...
    <!-- END MAIN CONTENT-->
     <!-- MODAL EDIT -->
  <form id="editbrand" name="editbrand" method="POST" action="javascript:void(0);">
    @csrf
         ...
         <div class="col-2"></div><div class="col-8"><h6 id="responseeditcheck"></h6></div>
          <div class="modal-body">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <input type="text" name="brand_id_edit" id="brand_id_edit" class="form-control" readonly>
              </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <select class="selectpicker form-control col-4" name="brand_status_edit" id="brand_status_edit">
          ...
          <div class="modal-footer">
            <button type="button" id="closed_br" data-backdrop="false" class="btn btn-secondary" data-dismiss="modal">Close</button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" id="closed_branddel" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="closed_brand_del" class="btn btn-secondary" data-dismiss="modal">No</button>
